...
export const STATUS_LABELS = {
  ...
  preparing: { label: 'Készül', color: 'bg-amber-100 text-amber-700 border-amber-200' },
  ready: { label: 'Kész', color: 'bg-purple-100 text-purple-700 border-purple-200' },
  on_route: { label: 'Úton', color: 'bg-orange-100 text-orange-700 border-orange-200' },
  delivered: { label: 'Kiszállítva', color: 'bg-emerald-100 text-emerald-700 border-emerald-200' },
  cancelled: { label: 'Törölve', color: 'bg-rose-100 text-rose-700 border-rose-200' },
};
