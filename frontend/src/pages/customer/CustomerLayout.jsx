...
import { Search, ShoppingCart, Instagram, Facebook, Heart } from 'lucide-react';
    ...
    <header className="sticky top-0 z-30 bg-neutral-950/85 backdrop-blur border-b border-neutral-900">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-6">
        ...
        <div className="relative w-72 hidden md:block">
          ...
          <input placeholder="Keresés az ételek között..." className="w-full pl-9 pr-3 py-2 rounded-full bg-neutral-900 border border-neutral-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#d4af37]" />
        </div>
